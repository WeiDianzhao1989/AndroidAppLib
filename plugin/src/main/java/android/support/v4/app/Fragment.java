...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    protected void performActivityCreated(Bundle savedInstanceState) {
        if (mChildFragmentManager != null) {
            mChildFragmentManager.noteStateNotSaved();
        }
        mCalled = false;
    ...
    */
    ...
    protected boolean performCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        boolean show = false;
        if (!mHidden) {
    ...
    protected boolean performPrepareOptionsMenu(Menu menu) {
        boolean show = false;
        if (!mHidden) {
            if (mHasMenu && mMenuVisible) {
                show = true;
    ...
    protected void performOptionsMenuClosed(Menu menu) {
        if (!mHidden) {
            if (mHasMenu && mMenuVisible) {
    ...
    protected void performSaveInstanceState(Bundle outState) {
    ...
    protected void performReallyStop() {
        if (mChildFragmentManager != null) {
