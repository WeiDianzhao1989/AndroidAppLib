...
import static com.koudai.net.kernal.internal.http.HttpEngine.MAX_FOLLOW_UPS;
...
final class RealCall implements Call {
        ...
        this.client = client.newBuilder()
                .addNetworkInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        if (originalResponse == null) throw new IOException("response null");
    ...
    @Override
    public boolean execute(Callback responseCallback){
